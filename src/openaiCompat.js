...
function usage(promptBlocks, completionText) { const promptTokens = estimateTokens(promptTextForUsage(promptBlocks)); const completionTokens = estimateTokens(completionText); return { prompt_tokens: promptTokens, completion_tokens: completionTokens, total_tokens: promptTokens + completionTokens }; }
